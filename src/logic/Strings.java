...
public class Strings {
    ...
    public static final String PRODUCT = "Termék";
    public static final String ORDER = "Rendelés";
    public static final String CATEGORY = "Kategória";
    public static final String FULFILL = "Teljesít";
    public static final String TO_CART = "Kosárba";
    public static final String MY_CART = "Kosaram";
    public static final String ERROR_NO_SELECTION = "Hiba: Nincs kijelölve semmi!";
    public static final String ERROR_NEGATIVE = "Hiba: Negatív szám!";
    public static final String ERROR_NUMBER_FORMAT = "Hiba: Nem szám!";
    public static final String ERROR_ZERO = "Hiba: 0 érték!";
    public static final String AMOUNT = "Mennyiség";
    public static final String START_SHOPPING = "Új rendelés";
